...
export const Footer = () => {
  return (
    <footer className="w-full mt-12 bg-white backdrop-blur-xl border-t border-white/40 shadow-[0_-8px_30px_rgba(0,0,0,0.05)]">
      <div className="max-w-4xl mx-auto px-6 py-8 text-center">
        <p className="text-sm text-gray-700">
          © 2025 <span className="font-semibold text-pink-500">Vivien Wallbaum</span> – Danke fürs Vorbeischauen!
        </p>
        ...
        {/* Optional: kleine Social-Icons oder Links */}
