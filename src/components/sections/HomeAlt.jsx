...
export const Home = () => {
  ...
  <div className="relative w-full max-w-3xl mx-auto">
    ...
    <h1 className="text-2xl md:text-3xl text-gray-800 typing-text">
      Hi, ich bin{' '} <span className="text-pink-500 text-4xl font-dancing inline">Vivien</span>{' '}
    und ich liebe es, Code und Kreativität zu verbinden.</h1>
